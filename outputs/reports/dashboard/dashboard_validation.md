...
| history:champion_probability_history.csv:no_duplicate_run_entries | pass | 14 rows, no duplicate ['run_id', 'team'] entries |
| history:finalist_probability_history.csv:no_duplicate_run_entries | pass | 14 rows, no duplicate ['run_id', 'team'] entries |
| history:finalist_pair_probability_history.csv:no_duplicate_run_entries | pass | 24 rows, no duplicate ['run_id', 'finalist_team_1', 'finalist_team_2'] entries |
| history:probability_source_history.csv:no_duplicate_run_entries | pass | 7 rows, no duplicate ['run_id'] entries |