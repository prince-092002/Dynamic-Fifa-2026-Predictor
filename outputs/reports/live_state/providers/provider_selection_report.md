...
- Selected provider status: available_true_live

| Provider | Status | Fixtures | Completed | Standings | Bracket | Score |
|---|---|---:|---:|---:|---:|---:|
| football_data_org | available_true_live | 104 | 101 | 144 | 32 | 105 |
...
Provider selection never treats fallback bracket mapping as official.