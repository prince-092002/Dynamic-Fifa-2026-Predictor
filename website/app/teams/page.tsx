  ...
  return (
    <div className="relative">
      ...
      <div className="relative mx-auto max-w-[78rem] px-4 py-14">
        ...
        <p className="mt-3 max-w-2xl text-fg2">All {payload.teams.length} tournament teams with real completed-match records, live status, and {finalStage ? "current championship probabilities for the confirmed finalists" : "current champion and finalist odds"}. Select a team for its full dossier.</p>
        <TeamExplorer teams={payload.teams} finalStage={finalStage} />
      </div>
    </div>
  );
}
